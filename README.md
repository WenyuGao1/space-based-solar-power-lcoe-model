...
[![Tests](https://github.com/WenyuGao1/space-based-solar-power-lcoe-model/actions/workflows/tests.yml/badge.svg)](https://github.com/WenyuGao1/space-based-solar-power-lcoe-model/actions/workflows/tests.yml)
...
[![Interactive explorer](https://img.shields.io/badge/Interactive%20Explorer-Open-0F766E.svg)](https://wenyugao1.github.io/space-based-solar-power-lcoe-model/html/)

[Open the interactive explorer](https://wenyugao1.github.io/space-based-solar-power-lcoe-model/html/) · [English report](report/final_report_EN.md) · [中文报告](report/final_report_zh.md) · [Verification note](report/verification_note.md)
...
[![Interactive SBSP LCOE model](html/social-preview.png)](https://wenyugao1.github.io/space-based-solar-power-lcoe-model/html/)
